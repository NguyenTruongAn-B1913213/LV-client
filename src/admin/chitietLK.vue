        ...
        <div class="main_ChiTietLichKham">
            ...
            <div div class=" button-submit-chitiet">
                <div class="button-submit-capnhat">
                    <button @click="adminConfirmAppointment(appointment._id)" class="huy btn btn-success">Xác Nhận</button>
                </div>
                <div class="button-submit-capnhat">
                    <router-link :to="`/XNLichKham`">
                        <button class="capnhat btn btn-success">Trở Lại</button>
                    </router-link>
                </div>
            </div>
        </div>
    ...
    methods: {
        ...
        async updateTrangThaiLK(e) {
            ...
            try {
                ...
                this.appointment.trangThai = "Xác Nhận";
